...
\begin{tabular}{L!{\VRule}R}
	\textit{\textbf{[c7]}} &\textbf{3DSliceLeNet: An Efficient CNN for Object Class Recognition from Point Clouds.} Francisco Gomez-Donoso, Alberto Garcia-Garcia, Jose Garcia-Rodriguez, Sergio Orts-Escolano, Miguel Cazorla. International Joint Conference on Neural Networks (IJCNN 2017) (Under review).\\
	& \\
