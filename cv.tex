...
\begin{tabular}{L!{\VRule}R}
	\emph{\textbf{[j5]}} & \textbf{Multi-sensor 3D Object Dataset for Object Recognition with Full Pose Estimation}. Alberto Garcia-Garcia, Sergio Orts-Escolano, Sergiu Oprea, Jose Garcia-Rodriguez, Jorge Azorin-Lopez, Marcelo Saval-Calvo, Miguel Cazorla. Neural Computing and Applications (2015). \emph{(Under review, Minor changes)}.\\
	& \\ 
...
\begin{itemize}
	\item \textbf{Deep Learning (Ongoing)}\\ Online at Udacity, 2016.
